...
import { buildCoupangPreview } from "@/lib/marketplace-api-helpers";
...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    console.error("[coupang-api] 미리보기 오류:", message);
    return NextResponse.json({ error: "쿠팡 API 미리보기 생성 실패" }, { status: 500 });
  }
}
