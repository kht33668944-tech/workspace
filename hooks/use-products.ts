...
const PRODUCT_LIST_COLUMNS =
  "id, user_id, product_name, lowest_price, margin_rate, category, source_category, purchase_url, memo, sort_order, thumbnail_url, image_urls, source_platform, detail_image_url, registration_status, rebuild_status, platform_codes, seller_code, fixed_price_smartstore, fixed_price_esm, fixed_price_coupang, created_at, updated_at";
