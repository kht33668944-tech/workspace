...
export function purchaseDetailUrl(platform: string, orderNo: string): string | null {
  if (!orderNo) return null;
  switch (platform) {
    case "gmarket": return `https://my.gmarket.co.kr/ko/pc/detail/basic/${orderNo}`;
    case "ohouse": return `https://ohou.se/orders/${orderNo}`;
    default: return null;
  }
}
